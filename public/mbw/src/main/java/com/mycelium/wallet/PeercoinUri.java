 ...
 * purpose.
 */
public class PeercoinUri implements Serializable {
   ...
   public PeercoinUri(Address address, Long amount, String label) {
      this.address = address;
      this.amount = amount;
      this.label = label == null ? null : label.trim();
   }

   public static PeercoinUri parse(String uri, NetworkParameters network) {
      try {
         Uri u = Uri.parse(uri);
         ...
         return new PeercoinUri(address, amount, label);
   ...
   public static PeercoinUri fromAddress(Address address) {
